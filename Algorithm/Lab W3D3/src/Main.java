...
public class Main {
	...
	public static void main(String[] args) {
		...
		List<List<Integer>> components = findComponentsByDFS(graphs);
		List<List<Integer>> components2 = findComponentsByBFS(graphs);
	...
	public static List<List<Integer>> findComponentsByDFS(int[][] graphs) {
	...
	public static List<List<Integer>> findComponentsByBFS(int[][] graphs) {
		int size = graphs.length;
		int[] visitedVertices = new int[size];
